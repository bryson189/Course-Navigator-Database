...
mysqli_query($connection,"UPDATE login SET activation_code='$activation' WHERE email = '$email';");

include 'Send_Mail.php';
$to=$email;
$subject="Course Navigator Email verification"; //THIS RELIES ON USING PORT 8000
$body='Hello, <br/> <br/> Please click on the link below to verify your account at Course Navigator. <br/> <br/> <a href="http://localhost:8000/activation.php?code='.$activation.'">Activate My Account</a>';
Send_Mail($to,$subject,$body);

$msg= "Registration successful! A verification email has been sent.";	
session_destroy();
?>
<!DOCTYPE html>
<html>

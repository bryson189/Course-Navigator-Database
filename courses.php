...
if(isset($_SESSION['email'])){
	...
	header('Location: courses-logged-in.php');
	}
} 
?>
<!DOCTYPE html>
		  ...
		  <div class="row content">
		    ...
		    <div class="col-lg-10 text-left">
			    ...
			    <?php
					...
					$result = mysql_query("SELECT deptcode, coursenum, name FROM course ORDER BY deptcode", $db);
					if(!$result){
						die("Something went wrong with the query. " . mysql_error());
					}


					$starts_a = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'A%'");
					$starts_b = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'B%'");
					$starts_c = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'C%'");
					$starts_d = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'D%'");
					$starts_e = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'E%'");
					$starts_f = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'F%'");
					$starts_g = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'G%'");
					$starts_h = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'H%'");
					$starts_i = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'I%'");
					$starts_j = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'J%'");
					$starts_k = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'K%'");
					$starts_l = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'L%'");
					$starts_m = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'M%'");
					$starts_n = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'N%'");
					$starts_o = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'O%'");
					$starts_p = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'P%'");
					$starts_q = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'Q%'");
					$starts_r = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'R%'");
					$starts_s = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'S%'");
					$starts_t = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'T%'");
					$starts_u = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'U%'");
					$starts_v = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'V%'");
					$starts_w = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'W%'");
					$starts_x = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'X%'");
					$starts_y = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'Y%'");
					$starts_z = mysql_query("SELECT deptcode, coursenum, name FROM course WHERE deptcode LIKE 'Z%'");
